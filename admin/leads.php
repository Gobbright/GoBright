...
<head>
  ...
  <title>GoBright Admin | Lead Form Data</title>
    ...
    <div class="main-wrap">
      ...
      <header class="main-header">
        <button class="mobile-menu-btn" type="button">
          ...
          <h1 class="dashboard-title">Lead Form Data</h1>
        </div>
      ...
      <section class="section active" id="section-leads">
        <div class="panel-box">
          <div class="sub-panel-head"><span class="sub-panel-title">Enquiries</span><span class="item-count">0</span></div>
          <div class="empty-state" style="padding:48px 24px">Connect PHP backend to view lead form submissions.</div>
        </div>
      </section>
