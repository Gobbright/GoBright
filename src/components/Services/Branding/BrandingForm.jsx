...
export default function BrandingForm({ title = "Ready to Grow?", sub = "Your GoBright Growth Partner is Here" }) {
  ...
  const fieldClass = (name) => `${inputClass} ${errors[name] ? "border-[#e32028]" : ""}`;

  return (
    <form onSubmit={submit} noValidate className="mx-auto w-full max-w-[520px] rounded-2xl bg-white p-6 shadow-[0_12px_50px_rgba(0,0,0,0.18)]">
